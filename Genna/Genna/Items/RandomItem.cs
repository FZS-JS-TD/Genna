            ...
            else if (r2 > 40 && r2 < 66)
            {
                ...
                if (r3 < 61)
                {
                    ...
                    if (r4 < 34)
                    {
                        ...
                        {
                            plusSpeed = rand.Next(1, 3);
                        }
                        else if (rPlusSpeed > 80)
                        {
                            plusSpeed = rand.Next(3, 6);
                        }
                        else
                        {
                            plusSpeed = 0;
                ...
                else if (r3 > 60 && r3 < 86)
                {
                    ...
                    if (r4 < 34)
                    {
                        ...
                        if (rPlusSpeed > 40 && rPlusSpeed < 81)
                        {
                            plusSpeed = rand.Next(7, 10);
                        }
                        else if (rPlusSpeed > 80)
                        {
                            plusSpeed = rand.Next(10, 12);
                        }
                        else
                        {
                            plusSpeed = 0;
                ...
                else if (r3 > 85)
                {
                    ...
                    if (r4 < 34)
                    {
                        ...
                        if (rPlusSpeed > 40 && rPlusSpeed < 81)
                        {
                            plusSpeed = rand.Next(12, 14);
                        }
                        else if (rPlusSpeed > 80)
                        {
                            plusSpeed = rand.Next(14, 16) + (zan.Luck / 3);
                        }
                        else
                        {
                            plusSpeed = 0;
            ...
            else if (r2 > 65 && r2 < 91)
            {
                ...
                if (r3 < 51)
                {
                    ...
                    if (r4 < 21)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(31, 60) - zan.Luck;
                        }
                        else
                        {
                            fireRate = rand.Next(20, 30) - (zan.Luck / 2);
                        }
                    ...
                    else if (r4 > 35 && r4 < 51)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(81, 100) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                    ...
                    else if (r4 > 50 && r4 < 63)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(21, 40) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(15, 25) - (int)(0.5 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 28 && fireRate < 20 && bulletSpeed > 200)
                        {
                            id = "Wombat";
                        }
                    ...
                    else if (r4 > 62 && r4 < 75)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(31, 40) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(15, 25) - (int)(0.5 * zan.Luck);
                    ...
                    else if (r4 > 74 && r4 < 86)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(100, 150) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(60, 100) - (int)(0.5 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 80 && fireRate < 90 && bulletSpeed > 350)
                        {
                            id = "Needle";
                        }
                    ...
                    else if (r4 > 85 && r4 < 96)
                    {
                        ...
                        {
                            fireRate = rand.Next(130, 160) - (int)(0.5 * zan.Luck);
                        }

                        //determines bulletSpeed
                        if (rBulletSpeed < 70)
                        {
                            bulletSpeed = rand.Next(30, 80) + zan.Luck;
                        }
                        else
                        {
                            bulletSpeed = rand.Next(80, 150) + zan.Luck;
                        }
                        ...
                        //legendary
                        if (damage > 140 && fireRate < 150 && bulletSpeed > 125)
                        {
                            id = "Show Stopper";
                        }
                        ...
                        RocketLauncher rl = new RocketLauncher(game.Content.Load<Texture2D>("Weapons/rocketLauncher"), tier, type, id, value, damage, fireRate, 1, 5, bulletSpeed);
                    ...
                    else if (r4 > 95)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(80, 140) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(60, 90) - (int)(0.5 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 70 && fireRate < 80 && bulletSpeed > 475)
                        {
                            id = "Sparky";
                        }
                ...
                else if (r3 > 50 && r3 < 86)
                {
                    ...
                    if (r4 < 21)
                    {
                        ...
                        {
                            fireRate = rand.Next(18, 30) - (int)(0.5 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 83 && fireRate < 26 && bulletSpeed > 225)
                        {
                            id = "Silk";
                        }
                    ...
                    else if (r4 > 20 && r4 < 36)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(13, 30) - (int)(0.25 * zan.Luck);
                        }
                        else
                        {
                    ...
                    else if (r4 > 35 && r4 < 51)
                    {
                        ...
                        {
                            fireRate = rand.Next(40, 70) - (int)(0.5 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 90 && fireRate < 60 && bulletSpeed > 225 && spreadBullets > 13)
                        {
                            id = "Boomstick";
                        }
                    ...
                    else if (r4 > 50 && r4 < 63)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(20, 40) - (int)(0.25 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(13, 25) - (int)(0.25 * zan.Luck);
                        }
                    ...
                    else if (r4 > 74 && r4 < 86)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(80, 120) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(60, 90) - (int)(0.5 * zan.Luck);
                        ...
                        //legendary
                        if (damage > 285 && fireRate < 80 && bulletSpeed > 375)
                        {
                            id = "Bloodwing";
                        }
                    ...
                    else if (r4 > 85 && r4 < 96)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(130, 180) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(100, 140) - (int)(0.5 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 580 && fireRate < 130 && bulletSpeed > 135)
                        {
                            id = "General Sherman";
                        }
                    ...
                    else if (r4 > 95)
                    {
                        ...
                        //legendary
                        if (damage > 285 && fireRate < 80 && bulletSpeed > 500)
                        {
                            id = "The Juicer";
                        }
                ...
                else if (r3 > 85)
                {
                    ...
                    if (r4 < 21)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(29, 70) - (int)(0.25 * zan.Luck);
                        }
                        else
                        {
                    ...
                    else if (r4 > 20 && r4 < 36)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(11, 28) - (int)(0.15 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(8, 14) - (int)(0.15 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 208 && fireRate < 13 && bulletSpeed > 250)
                        {
                            id = "The Honeybadger";
                        }
                    ...
                    else if (r4 > 35 && r4 < 51)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(45, 80) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(35, 60) - (int)(0.5 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 290 && fireRate < 45 && bulletSpeed > 250 && spreadBullets > 16)
                        {
                            id = "A Thousand Waves";
                        }
                    ...
                    else if (r4 > 50 && r4 < 63)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(20, 35) - (int)(0.15 * zan.Luck);
                        }
                        else
                        {
                        ...
                        //legendary
                        if (damage > 310 && fireRate < 19 && bulletSpeed > 250)
                        {
                            id = "The Metronome";
                        }
                    ...
                    else if (r4 > 74 && r4 < 86)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(70, 110) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(60, 90) - (int)(0.5 * zan.Luck);
                        ...
                        //legendary
                        if (damage > 800 && fireRate < 75 && bulletSpeed > 425)
                        {
                            id = "Star-Hunter";
                        }
                    ...
                    else if (r4 > 85 && r4 < 96)
                    {
                        ...
                        if (rFireRate < 80)
                        {
                            fireRate = rand.Next(120, 170) - (int)(0.5 * zan.Luck);
                        }
                        else
                        {
                            fireRate = rand.Next(90, 130) - (int)(0.5 * zan.Luck);
                        }
                        ...
                        //legendary
                        if (damage > 1500 && fireRate < 120 && bulletSpeed > 150)
                        {
                            id = "Papa Bear";
                        }
                    ...
                    else if (r4 > 95)
                    {
                        ...
                        //legendary
                        if (damage > 800 && fireRate < 75 && bulletSpeed > 550)
                        {
                            id = "Zapdos";
                        }
